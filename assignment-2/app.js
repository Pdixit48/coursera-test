(function () {
	...
	//This is the controller that will be responsible for the list which contain all the item to buy
	...
	//This is the controller that will be responsible for the AllreadyBoughtList
	...
	//This is the service method which will perform all the business logic and share the data between 2 controllers as well
    ...
    // this is the methode which remove the item from to buy list and push that item to Allready Bought list
